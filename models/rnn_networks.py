...
class Actor(nn.Module):
    ...
    def get_action_and_sleep_ticks(self, x, entropy_threshold, max_sleep_ticks=3, action=None):
        ...
        sleep_ticks = torch.where(entropy <= entropy_threshold, max_sleep_ticks_tensor, torch.zeros_like(max_sleep_ticks_tensor))
...
class AsynchronousGRUActor(nn.Module):
    ...
    def get_action_and_sleep_ticks(self, x, hidden_states, active_masks, entropy_threshold, max_sleep_ticks=3, action=None):
        """
